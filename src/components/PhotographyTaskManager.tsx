...
import { ArrowLeft, Plus, Search, Star, Calendar, User, Camera, Image, Album, Package, Link, DollarSign, Clock, CheckCircle, Circle, MoreHorizontal, Bell, Paperclip, MessageSquare, X, Edit3, Trash2, Save, Filter, SortAsc, Eye, Phone, Mail, MapPin, Hash, FileText, Upload, Download } from 'lucide-react';
      ...
      <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3 text-sm text-gray-600">
            ...
            <div>
              <div className="font-medium text-gray-900">{user.user_metadata?.full_name || 'Fotógrafo'}</div>
              <div>{user.email}</div>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-200">
          <button className="w-full flex items-center justify-center gap-2 py-2 text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-4">
              {showNewTask ? (
                ...
                <button
                  ...
                  className="flex items-center gap-3 text-gray-500 hover:text-gray-700 transition-colors w-full"
                >
            ...
            {selectedTask && (
              ...
              >
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{selectedTask.client_name}</p>
                      </div>
                    </div>
                    <button
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {selectedTask.client_email && (
                        <div className="flex items-center gap-2">
                          ...
                          <span>{selectedTask.client_email}</span>
                        </div>
                      )}
                      {selectedTask.client_phone && (
                        <div className="flex items-center gap-2">
                          <Phone className="h-4 w-4 text-gray-400" />
                          <span>{selectedTask.client_phone}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {/* Task Details */}
                  <div>
                    <h4 className="font-medium text-gray-900 mb-3">Detalhes da Tarefa</h4>
                    <div className="space-y-3">
                      ...
                      {selectedTask.photos_count && (
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">{selectedTask.photos_count}</span>
                        </div>
                      )}
                  ...
                  {selectedTask.gallery_link && (
                    <div>
                      <h4 className="font-medium text-gray-900 mb-3">Link da Galeria</h4>
